...
const painPoints = [
  ...
  "ניסיתי ChatGPT אבל לא באמת יצא מזה משהו שימושי",
  "אין לי מושג מה לכתוב יותר, נגמרו לי הרעיונות",
  "כל פוסט תלוי במעצבים ועורכי וידאו והופך לפרויקט",
];
...
בשיחת אבחון קצרה נבין איפה העסק נמצא היום, איזה תכנים הוא צריך לייצר, ואיך הדרכת AI אישית 1:1 יכולה לעזור לך ליצור פוסטים, סרטונים ודפי נחיתה בעצמך.
