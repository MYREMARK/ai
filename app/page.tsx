...
const painPoints = [
  "נמאס לי להיות המנהל, המזכירה, איש המקצוע והמשווק של עצמי",
  "ניסיתי ChatGPT אבל לא יצא מזה משהו שימושי",
  "אין לי מושג מה לכתוב יותר, נגמרו לי הרעיונות",
  "כל פוסט וכל סרטון תלוי במעצבים ועורכי וידאו והופך לפרויקט",
];
...
const faqItems = [
  {
    ...
    answer:
      "לא. ההדרכה בנויה גם למי שניסה קצת את ChatGPT וגם למי שכבר מייצר תכנים באופן קבוע. המטרה היא לבנות דרך עבודה פשוטה וברורה שמתאימה לעסק שלך.",
  },
  {
    question: "מה קורה בשיחת האבחון?",
    answer:
      "בשיחת האבחון נבין מה העסק שלך עושה, איזה תכנים הוא צריך לייצר, איפה מתבזבז זמן היום, ואיך הדרכת AI אישית 1:1 יכולה לעזור לך לייצר פוסטים, סרטונים ודפי נחיתה בצורה עצמאית.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "איך לעבוד נכון עם ChatGPT, ליצור רעיונות ופוסטים, לבנות פרומפטים טובים יותר, ליצור תמונות, סרטונים קצרים, סנכרון שפתיים, דפי נחיתה ואתרים פשוטים בעזרת כלי AI.",
  },
];
...
const floatingNodes = [
  ...
  {
    size: "h-30 w-30 md:h-48 md:w-48",
    top: "top-[72%]",
    side: "right-[4%]",
...
<div className="pointer-events-none absolute inset-0 z-[1] overflow-hidden">
          ...
          >
            <div className="relative h-full w-full rounded-full opacity-70 blur-[2px] md:opacity-100 md:blur-[3px]">
              <div className="absolute inset-0 rounded-full bg-cyan-300/14 blur-[52px] md:blur-[72px]" />
              <div className="absolute inset-[6%] rounded-full bg-fuchsia-400/10 blur-[44px] md:blur-[64px]" />

              <div className="absolute inset-0 rounded-full border border-cyan-200/18 bg-white/[0.035] shadow-[0_0_90px_rgba(103,232,249,0.22)] backdrop-blur-xl md:border-cyan-200/22 md:bg-white/[0.045] md:shadow-[0_0_120px_rgba(103,232,249,0.26)]" />

              <div className="absolute inset-[10%] rounded-full border border-white/8 blur-[1px]" />
              <div className="absolute inset-[24%] rounded-full border border-cyan-200/10 blur-[1px]" />

              <div className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_30%_30%,rgba(255,255,255,0.14),transparent_22%),radial-gradient(circle_at_65%_70%,rgba(103,232,249,0.14),transparent_30%),linear-gradient(135deg,rgba(103,232,249,0.14),transparent_48%,rgba(217,70,239,0.10))] blur-[2px]" />

              <div className="absolute left-1/2 top-1/2 h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-200/80 shadow-[0_0_34px_rgba(103,232,249,0.95)] blur-[1px] md:h-3 md:w-3" />
              <div className="absolute left-1/2 top-1/2 h-8 w-8 -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-200/16 blur-[1px]" />

              <div className="absolute left-[18%] top-[22%] h-1.5 w-1.5 rounded-full bg-white/60 shadow-[0_0_18px_rgba(255,255,255,0.7)] blur-[1px]" />
              <div className="absolute right-[20%] top-[30%] h-1 w-1 rounded-full bg-cyan-200/70 shadow-[0_0_16px_rgba(103,232,249,0.8)] blur-[1px]" />
              <div className="absolute bottom-[20%] left-[28%] h-1 w-1 rounded-full bg-fuchsia-200/60 shadow-[0_0_14px_rgba(217,70,239,0.7)] blur-[1px]" />
            </div>
          </div>
        ))}
      </div>
...
בשיחת אבחון קצרה נבין איפה העסק נמצא היום, איזה תכנים הוא מייצר, ואיך הדרכת AI אישית 1:1 יכולה לעזור לך ליצור תכנים ודפי נחיתה בעצמך.
