...
const learningTracks = [
  ...
  },
  {
    ...
    text:
      "נבנה עמודי נחיתה שנראים פרימיום וממירים מהר, בעזרת כלים כמו Lovable ו - VsCode בלי לחכות שבועות או להסתבך טכנית ובלי לשלם אלפים על כל עמוד חדש לקמפיין או להצעה שלך.",
  },
];
